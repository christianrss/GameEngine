...
namespace GameEngine
{
    ...
    abstract public class Object3D : IDisposable, IRenderable, ICullable, ICollidable, IDynamic
    {
        ...
        protected ObjectUpdate m_UpdatedMethod = null;
        ...
        {
            get { return m_vOrientation.Roll; }
            set { m_vOrientation.Roll = value; }
        }
        public virtual float Pitch
        {
            get { return m_vOrientation.Pitch; }
            set { m_vOrientation.Pitch = value; }
        }
        public virtual float Heading
        {
            get { return m_vOrientation.Heading; }
        ...
        {
            // Check to see if the object is whting this rectangle.
            return false;
        }
