...
namespace GameEngine
{
    ...
    public class Console : IDisposable
    {
        ...
        public Console(GraphicsFont pFont, string sFileName)
        {
            ...
            AddCommand("SET", "Set a parameter to a value", new CommandFunction(Set));
            AddCommand("HELP", "Display command an Parameter help", new CommandFunction(Help));
            AddCommand("CONSOLESIZE", "The percentage of the screen covered by the console from 1.0 to 100.0", new CommandFunction(SetScreenSize));
        }
        ...
        public static void Render()
        {
            if (m_bVisible)
            {
                ...
                // determine how much of the console will be visible base on wheter it is opening,
                // open, or closing
        ...
        /// <summary>
        /// add a lien to the bottom of the console
        /// </summary>
        ...
        /// <summary>
        /// Respon to a cairrage return and process entry line
        /// </summary>
        ...
        /// <summary>
        /// Get the console's visiblity status
        /// </summary>
        /// <returns></returns>
