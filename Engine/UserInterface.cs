...
namespace GameEngine
{
    ...
    {
        private int m_X = 0; // X position of button on screen
        private int m_Y = 0; // Y position of the button on the scren
        ...
        private Image m_HoverImage = null; // what the button looks like when hover
        ...
        public ImageButton(int nX, int nY, string sOffFilename, string sOnFileName, string sHoverFilename, ButtonFunction pFunc)
        {
            m_X = nX;
            m_Y = nY;
    ...
    public class OptionScreen : IDisposable
    {
        ...
        public OptionScreen(string filename)
        {
            try
            {
                ...
                m_Cursor = new Image(@"..\..\Resource\Cursor.dds");
