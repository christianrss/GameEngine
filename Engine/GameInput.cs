...
namespace GameEngine
{
    ...
    /// a unified interface for the game engine where the stauts of any of these input devices
    /// may be polled. More importantly it provide the capability to invoke a supplied method
    ...
    public class GameInput : IDisposable
    {
        ...
        public GameInput(System.Windows.Forms.Form form)
        {
            ...
            try
            {
                ...
                // Enumerate joysticks in the systme.
                ...
                if ((ex is NotAcquiredException))
                {
                    ...
                    catch (InputException ex2)
                    {
                        if (ex2 is OtherApplicationHasPriorityException)
                        {
                            ...
                            // Console.AddLine("An unknown error has ocurred. This app won't be able to process device info.");
                        }
            ...
            catch (InputException ex)
            {
                ...
                if ((ex is NotAcquiredException))
                {
                    ...
                    catch (InputException ex2)
                    {
                        ...
                        {
                            // Something very odd happened
                            System.Diagnostics.Debug.WriteLine("An unknown error has occurred. This app won't be able to process device info. " + ex2.ErrorString);
                            // Failed to aquire the device.
                            // This could be because the app
                            // doesn't have focus.
                            bMouseOk = false;
            ...
            catch (InputException ex)
            {
                ...
                if ((ex is NotAcquiredException))
                {
                    ...
                    catch (InputException ex2)
                    {
                        ...
                        {
                            // something very odd happened.
                            //Console.AddLine("An unknown error has occurrred. This app won't be able to process device info.");
                        }
                        // Failed to aquire the device.
                        // This could be because the app
                        // doesn't have focus.
